...
class NonHierarchyChange(models.Model):
    projectmap = models.ForeignKey(ProjectStructure,blank=False,null=False)
    action = models.ForeignKey(NonHierarchyAction,blank=False,null=False)
...
class HinyangoPermissionActive(models.Model):
    project_user = models.ForeignKey(AccountProfile)
    authorised_for = models.ForeignKey(HinyangoPermissions)
