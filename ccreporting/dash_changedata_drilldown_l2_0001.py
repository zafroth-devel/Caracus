...
class dashdata_change_drilldown_l2(DataContext):
  ...
  "data": [
    {
      "name": "scores",
      "values": @@DATA@@,
      "format": {"type": "json", "parse": {"level": "string", "score": "number","day":"string","sorty":"number","sortm":"number"}}
      }
  ],
